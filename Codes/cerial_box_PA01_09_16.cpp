...
int main() {
    ...
    weight_metric_ton = weight_ounces / ounces_per_metric_ton;
    ...
    boxes_to_metric_ton = ounces_per_metric_ton / weight_ounces;

    // Display the weight of one box in metric tons
    cout << "Weight of one box in metric tons: " << weight_metric_ton << endl;

    // Display the number of boxes needed for one metric ton
    cout << "The number of boxes needed for one metric ton" << boxes_to_metric_ton << endl;
